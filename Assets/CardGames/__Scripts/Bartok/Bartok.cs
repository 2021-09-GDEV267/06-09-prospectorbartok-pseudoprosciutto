...
//different phases of a game turn
...
// int num = -1 here is a default value. overloading the method with a default if there is no int naturally.
    ...
    {                                       // f
        ...
        Utils.tr("Bartok:PassTurn()", "Old: " + lastPlayerNum, "New: " + CURRENT_PLAYER.playerNum);                              // h
    }
    ...
    {
        CardBartok cd = drawPile[0];     // Pull the 0th
    ...
    /* UPDATE METHOD USED FOR INPUT READING FOR TESTING DEALING CARDS
